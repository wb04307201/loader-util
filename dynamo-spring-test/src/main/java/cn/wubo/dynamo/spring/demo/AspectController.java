...
import cn.wubo.dynamo.spring.demo.advice.LoggingAdvice;
import cn.wubo.dynamo.spring.demo.advice.ThrowAdvice;
import cn.wubo.dynamo.spring.demo.advice.TimingAdvice;
...
public class AspectController {
    ...
    public ResponseEntity<Map<String, Object>> proxy(@RequestBody ProxyRequest req) {
        ...
        try {
            ...
            // 保证代理类能找到目标类
            proxy = DynamoProxy.proxy(clazz, advice, loader);
