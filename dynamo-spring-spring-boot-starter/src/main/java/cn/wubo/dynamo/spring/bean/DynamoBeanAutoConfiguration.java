...
/**
 * 自动配置：让 Spring MVC 使用 {@link DynamoRequestMappingHandlerMapping} 替代默认的
 ...
 */
@AutoConfiguration
public class DynamoBeanAutoConfiguration {
    ...
    public WebMvcRegistrations dynamicWebMvcRegistrations() {
        return new WebMvcRegistrations() {
            ...
            public RequestMappingHandlerMapping getRequestMappingHandlerMapping() {
                return new DynamoRequestMappingHandlerMapping();
            }
        };
    }
}
